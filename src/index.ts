...
export type { HotelSearchV2Service } from './services/hotel-search-v2/service.js';
export type {
  AddressRef,
  GeoCodeRef,
  GeoRef,
  ...
  SearchHotelsInput,
  SearchHotelsOutput,
} from './services/hotel-search-v2/types.js';
