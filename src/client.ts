...
import {
  DefaultHotelPriceCheckV5Service,
  type HotelPriceCheckV5Service,
} from './services/hotel-price-check-v5/service.js';
import {
  DefaultHotelSearchV2Service,
  type HotelSearchV2Service,
} from './services/hotel-search-v2/service.js';
import {
...
export interface SabreClient {
   ...
   * covering airports, cities, rail stations, points of interest, and
   * general locations.
   */
   ...
   *
   * Returns lead rates across multiple hotel properties in one call and
   ...
   *
   * Revalidates a shopped hotel rate and returns the booking key,
   * price-change status, and refreshed rate details.
   */
   ...
   *
   * Returns matching hotel properties for a geographic anchor (lat/lon,
   * reference point, or address) plus a radius. Availability and rates
